...
function sbp_short_top_contact() { ?>
	...
	if($home_page_top_contact_enabled !='off'){
			...
			?>	 
			<div class="overlay"<?php if($short_top_contact_overlay != false) { ?>style="background-color:<?php esc_attr($short_top_contact_overlay_color); } ?> "> 
					<div class="row">
						<div class="col-md-4">
							<div class="mt-ct-info-wid">
								<div class="media">
									<div class="mt-ct-icon"><i class="<?php echo esc_attr($top_conact_one_icon); ?>"></i></div>
									<div class="media-body first-top">
										<h4><?php echo esc_html($top_contact_one_title); ?></h4>
										<h6><?php echo esc_html($top_contact_one_description); ?></h6>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="mt-ct-info-wid">
								<div class="media">
									<div class="mt-ct-icon"><i class="<?php echo esc_attr($top_conact_two_icon); ?>"></i></div>
									<div class="media-body two-top">
										<h4><?php echo esc_html($top_contact_two_title); ?></h4>
										<h6><?php echo esc_html($top_contact_two_description); ?></h6>
									</div>
								</div>
							</div>
						</div>	
						...
						<div class="col-md-4">
							<div class="mt-ct-info-wid">
								<div class="media">
									<div class="mt-ct-icon"><i class="<?php echo esc_attr($top_conact_three_icon); ?>"></i></div>
									<div class="media-body three-top">
										<h4><?php echo esc_html($top_contact_three_title); ?></h4>
										<h6><?php echo esc_html($top_contact_three_description); ?></h6>
									</div>
								</div>
							</div>		
						</div>
				...
				<div class="row">
					<div class="col-md-12 text-center">
						<div class="mt-sec-head">
							...
							<div class="mt-sec-backhead"><?php echo esc_html($short_service_subtitle); ?></div>
							<?php } if ( ! empty( $short_service_title )) { ?>
							<h4 class="mt-sec-subtitle"><?php echo esc_html($short_service_title); ?></h4>
							<?php } if($short_service_description) { ?>
							<h1 class="mt-sec-title"><?php echo esc_html($short_service_description); ?></h1>
							<?php } ?>
				...
				<div class="row">
					<div class="col-md-4 col-sm-6 col-xs-12">
							...
							<?php  $service_one_icon = get_theme_mod('service_one_icon','fa fa-newspaper-o'); ?>
								<div class="mt-ser-icon"><i class="<?php echo esc_attr($service_one_icon); ?>"></i></div>
								<div class="mt-ser-title">
								<?php  $service_one_title = get_theme_mod('service_one_title','Strategic Planning'); ?>
									<h4><?php echo esc_html($service_one_title); ?></h4>
								</div>		
							...
							$ser_one_btn_text = get_theme_mod('ser_one_btn_text','Read More');
							$ser_one_btn_tab = get_theme_mod('ser_one_btn_tab',false);
							if($ser_one_btn_text !='')
							{ ?>
							<a href="<?php echo esc_url($ser_one_btn_link); ?>" <?php if($ser_one_btn_tab == true){ echo 'target="_blank"';}?> class="btn-theme"><?php echo esc_html($ser_one_btn_text) ; ?></a>	
							<?php } ?></p>		
								</div>
							</article> 
						</div>
						<div class="col-md-4 col-sm-6 col-xs-12">
							...
							<?php  $service_two_icon = get_theme_mod('service_two_icon','fa fa-balance-scale'); ?>
								<div class="mt-ser-icon"><i class="<?php echo esc_attr( $service_two_icon); ?>"></i></div>
								<div class="mt-ser-title">
								<?php  $service_two_title = get_theme_mod('service_two_title','Trades & Stocks'); ?>
									<h4><?php echo esc_html($service_two_title); ?></h4>
								</div>		
								<div class="mt-ser-content">
							...
							$ser_two_btn_text = get_theme_mod('ser_two_btn_text','Read More');
							$ser_two_btn_tab = get_theme_mod('ser_two_btn_tab',false);
							if($ser_two_btn_text !='')
							{ ?>
							<a href="<?php echo esc_url($ser_two_btn_link); ?>" <?php if($ser_two_btn_tab == true){ echo 'target="_blank"';}?> class="btn-theme"><?php echo esc_html($ser_two_btn_text) ; ?></a>	
							<?php } ?></p>		
								</div>
							</article> 
						</div>
						<div class="col-md-4 col-sm-6 col-xs-12">
							...
							<?php  $service_three_icon = get_theme_mod('service_three_icon','fa fa-handshake-o'); ?>
								<div class="mt-ser-icon"><i class="<?php echo esc_attr( $service_three_icon); ?>"></i></div>
								<div class="mt-ser-title">
							...
							$ser_three_btn_text = get_theme_mod('ser_three_btn_text','Read More');
							$ser_three_btn_tab = get_theme_mod('ser_three_btn_tab',false);
							if($ser_three_btn_text !='')
							{ ?>
							<a href="<?php echo esc_url($ser_three_btn_link); ?>" <?php if($ser_three_btn_tab == true){ echo 'target="_blank"';}?> class="btn-theme"><?php echo esc_html($ser_three_btn_text) ; ?></a>	
							<?php } ?></p>		
								</div>
							</article> 
						</div> 
...
if ( ! function_exists( 'sbp_short_portfolio' ) ) :
	function sbp_short_portfolio() {
		...
		$project_title_one = get_theme_mod('project_title_one',__('Financial Project','shortbuild'));
		...
		$project_title_two = get_theme_mod('project_title_two',__('Investment','shortbuild'));
		...
		$project_title_three = get_theme_mod('project_title_three',__('Invoicing','shortbuild'));
		...
		if($project_section_enable !='off'){ ?>		
			...
			<section id="section" class="portfolio">
				...
				<div class="row">
					...
					<div class="col-md-12 text-center">
						<div class="mt-sec-head">
							<div class="mt-sec-backhead"><?php echo esc_html($short_project_subtitle); ?></div>
							<h4 class="mt-sec-subtitle"><?php echo esc_html($home_short_portfolio_section_discription); ?></h4>
							<h1 class="mt-sec-title"><?php echo esc_html($home_short_portfolio_section_title); ?></h1>
							<div class="divider-line"></div>
						</div>
					</div>
				...
				<div class="row">
					...
					<!--item-->
						...
						<div class="col-md-4 col-sm-6 col-xs-12 project-one">
							...
							<!--portfolio-->
								<figure class="post-thumbnail">
									<img src="<?php echo esc_url($project_image_one); ?>" alt="">
								</figure>
								<div class="post-content text-center">
									<header class="mt-header">
										<h4 class="mt-title"><a href="#"><?php echo esc_html($project_title_one); ?></a></h4>
									</header>	
									<div class="entry-content"><p><?php echo esc_html($project_desc_one); ?></p></div>
								</div>  
							<!--/portfolio-->
							</article>
						</div>
						...
						<div class="col-md-4 col-sm-6 col-xs-12 project-two">
							...
							<!--portfolio-->
								<figure class="post-thumbnail">
									<img src="<?php echo esc_url($project_image_two); ?>" alt="">
								</figure>
								<div class="post-content text-center">
									<header class="mt-header">
										<h4 class="mt-title"><a href="#"><?php echo esc_html($project_title_two); ?></a></h4>
									</header>	
									<div class="entry-content"><p><?php echo esc_html($project_desc_two); ?></p></div>
								</div>  
							<!--/portfolio-->
							</article>
						</div>
						...
						<div class="col-md-4 col-sm-6 col-xs-12 project-three">
							...
							<!--portfolio-->
								<figure class="post-thumbnail">
									<img src="<?php echo esc_url($project_image_three); ?>" alt="">
								</figure>
								<div class="post-content text-center">
									<header class="mt-header">
										<h4 class="mt-title"><a href="#"><?php echo esc_html($project_title_three); ?></a></h4>
									</header>	
									<div class="entry-content"><p><?php echo esc_html($project_desc_three); ?></p></div>
								</div>  
							<!--/portfolio-->
							</article>
						</div>
...
if ( ! function_exists( 'sbp_short_callout' ) ) :
	...
	function sbp_short_callout() {
		...
		$cta_title = get_theme_mod('cta_title',__('Need Consultation','shortbuild'));
		$cta_desc = get_theme_mod('cta_desc','Contact our customer support team if you have any further questions.');
		$cta_btn_lable = get_theme_mod('cta_btn_lable',__('Get appointment','shortbuild'));
		...
		if($homepage_callout_show !='off'){ ?>		
			...
			<!--container-->
			<section class="mt-calltoaction theme-default" style="background:url('<?php echo esc_attr($short_cta_background);?>') no-repeat center center /cover; ">
				<?php } else { ?>
			<section class="mt-calltoaction theme-default">
			<?php } ?>	 
			<div class="overlay"<?php if($short_cta_overlay != false) { ?>style="background-color:<?php echo esc_attr($cta_overlay_section_color); } ?> "> 
				<div class="container">
					<div class="row"> 
						<div class="col-md-12 col-sm-12 col-xs-12 text-center">
							<h2 class="title"><?php echo esc_html($cta_title); ?></h2>
							<p class="subtitle"><?php echo esc_html($cta_desc); ?></p>
							<div class="m-top-40">
								<a class="btn-theme" href="<?php echo esc_url($cta_btn_link); ?>" <?php if($cta_link_target) { ?> target="_blank" <?php } ?>><?php echo esc_html($cta_btn_lable); ?></a>
							</div>
						</div>  
					</div>      
				</div>
		...
		if($short_news_enable !='off'){ ?>		
			...
			<section id="section" class="blog">
				...
				<!--container-->
					...
					<div class="row">
						<div class="col-md-12">
							<div class="mt-sec-head text-center">
								<?php $short_news_subtitle = get_theme_mod('short_news_subtitle',__('NEWS','shortbuild'));?>
								<div class="mt-sec-backhead"><?php echo esc_html($short_news_subtitle); ?></div>
								<?php $news_section_title = get_theme_mod('news_section_title',__('News And Updates','shortbuild'));?>
								<h4 class="mt-sec-subtitle"><?php echo esc_html($news_section_title);?></h4>
							<?php $news_section_description = get_theme_mod('news_section_description',__('Recent Blog Posts','shortbuild'));?>
								<h1 class="mt-sec-title"><?php echo esc_html($news_section_description);?></h1>
								<div class="divider-line"></div>
							</div>
						</div>
					</div>
					...
					<!--col-md-4-->
					<?php 
					$news_section_post_count = get_theme_mod('news_section_post_count', __('3','shortbuild'));
					...
					<div class="col-md-4 col-sm-6 col-xs-12">
						...
						<div class="mt-post-content">
								...
								<header class="mt-header">		
									<h3 class="mt-title"><a href="<?php echo esc_url(get_permalink()); ?>" title="<?php the_title_attribute(); ?>"><?php get_the_title() ?></a></h3>	
								</header>					
								<div class="entry-content">
									<?php $short_post_content_type = get_theme_mod('short_post_content_type','content'); 
							if($short_post_content_type == 'content') {
								the_content(__('Read More','shortbuild'));
								}
								elseif($short_post_content_type == 'excerpt')
								{ ?>
									<p><?php shortbuild_news_excerpt(); ?></p>
