...
$selective_refresh = isset( $wp_customize->selective_refresh ) ? 'postMessage' : 'refresh';
	...
	$wp_customize->add_control( new Sbp_Short_Toggle_Switch_Custom_control( $wp_customize, 'home_page_slider_enabled',
		array(
			'label' => esc_html__( 'Slider Enable/Disable' , 'shortbuild'),
...
$selective_refresh = isset( $wp_customize->selective_refresh ) ? 'postMessage' : 'refresh';
	...
	$wp_customize->add_control( new Sbp_Short_Toggle_Switch_Custom_control( $wp_customize, 'home_page_top_contact_enabled',
		array(
			'label' => esc_html__( 'Top Contact Enable/Disable' , 'shortbuild'),
	...
	$wp_customize->add_control('short_top_contact_overlay', array(
		'label'    => __('Enable callout image overlay', 'shortbuild' ),
		'section'  => 'top_conatct_section',
		'type' => 'checkbox',
	) );
...
function sbp_short_service_customize_register($wp_customize){
	...
	$wp_customize->add_control( new Sbp_Short_Toggle_Switch_Custom_control( $wp_customize, 'service_section_show',
		array(
			'label' => esc_html__( 'Service Enable/Disable','shortbuild'),
...
$selective_refresh = isset( $wp_customize->selective_refresh ) ? 'postMessage' : 'refresh';	
	...
	$wp_customize->add_control( new Sbp_Short_Toggle_Switch_Custom_control( $wp_customize, 'project_section_enable',
		array(
			'label' => esc_html__( 'Project Enable/Disable' , 'shortbuild'),
	...
	'project_title_one', array(
		'default'        => __('Financial Project','shortbuild'),
		'capability'     => 'edit_theme_options',
		'sanitize_callback' => 'sanitize_text_field',
		'transport'         => $selective_refresh,
	));
	...
	'project_title_two', array(
		'default'        => __('Investment','shortbuild'),
		'capability'     => 'edit_theme_options',
		'sanitize_callback' => 'sanitize_text_field',
		'transport'         => $selective_refresh,
	));
	...
	'project_title_three', array(
		'default'        => __('Invoicing','shortbuild'),
		'capability'     => 'edit_theme_options',
		'sanitize_callback' => 'sanitize_text_field',
		'transport'         => $selective_refresh,
	));
...
function sbp_short_news_customize_register($wp_customize){
	...
	$wp_customize->add_section( 'news_section' , array(
		'title' => __('News settings', 'shortbuild'),
		'panel' => 'home_page_settings',
		'priority'   => 4,
	) );
	...
	$wp_customize->add_control( new Sbp_Short_Toggle_Switch_Custom_control( $wp_customize, 'short_news_enable',
		array(
			'label' => esc_html__( 'Latest News Enable/Disable','shortbuild' ),
	...
	$wp_customize->add_setting(
		...
		'capability' => 'edit_theme_options',
		'default' => __('News And Updates','shortbuild'),
		'transport' => $selective_refresh
	) );
	$wp_customize->add_control( 'news_section_title', array(
		'label' => __('News section title', 'shortbuild'),
		'section' => 'news_section',
		'type' => 'text',
	) );
	...
	$wp_customize->add_setting(
		...
		'capability' => 'edit_theme_options',
		'default' => __('Recent Blog Posts','shortbuild'),
		'transport' => $selective_refresh
	) );
	$wp_customize->add_control( 'news_section_description', array(
		'label' => __('News section description', 'shortbuild'),
		'section' => 'news_section',
		'type' => 'textarea',
	) );
	...
	$wp_customize->add_control( 'short_post_content_type', array(
		'type'     => 'radio',
		'label'    => esc_html__( 'Blog Post Content Type', 'shortbuild' ),
		'choices'  => array(
			'content'          => esc_html__( 'Content', 'shortbuild' ),
			'excerpt' => esc_html__( 'Excerpt', 'shortbuild' ),
		),
		'section'  => 'news_section',
	...
	$wp_customize->add_setting(
		...
		'capability' => 'edit_theme_options',
		'default' => __('180','shortbuild'),
	) );
	$wp_customize->add_control( 'short_excerpt_length', array(
		'label' => __('Excerpt length', 'shortbuild'),
		'section' => 'news_section',
		'type' => 'number',
	) );
	...
	$wp_customize->add_setting(
		...
		'capability' => 'edit_theme_options',
		'default' => __('3','shortbuild'),
	) );
	$wp_customize->add_control( 'news_section_post_count', array(
		'label' => __('Number of Items', 'shortbuild'),
		'section' => 'news_section',
		'type' => 'select',
		'choices' => array('3'=>__('3', 'shortbuild'),'6' => __('6','shortbuild'), '9' => __('9','shortbuild'),'12'=> __('12','shortbuild')),
	) );
}
...
function sbp_short_callout_customize_register($wp_customize){
	...
	$wp_customize->add_control( new Sbp_Short_Toggle_Switch_Custom_control( $wp_customize, 'homepage_callout_show',
		array(
			'label' => esc_html__( 'Callout Enable/Disable' , 'shortbuild'),
