...
function sbp_short_top_contact() { ?>
	...
	if($home_page_top_contact_enabled !='off'){
		...
		?>	 
		<div class="overlay"<?php if($short_top_contact_overlay != false) { ?>style="background-color:<?php echo esc_attr($short_top_contact_overlay_color); } ?> "> 
				<div class="row">
					<div class="col-md-4">
				...
				<div class="col-md-4 col-sm-6 col-xs-12">
					...
					<div class="mt-post-content">
							...
							<div class="entry-content">
								<?php the_content(__('Read More','shortbuild')); ?>
							</div>
						</div>
					</article>
					</div>
